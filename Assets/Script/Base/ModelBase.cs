...
{
    public class ModelBase : IBaseNotify
    {
        #region Excute
        ...
        public void Register(params int[] _EventMa)
        {
            ...
            ModelSystem.Instance.Add(this, mListEventMa.ToArray());
        }

        public void Cancel()
        {
            ModelSystem.Instance.Remove(this, mListEventMa.ToArray());
            mListEventMa.Clear();
        }
        ...
        public void Cancel(params int[] _EventMa)
        {
            ...
            {
                ModelSystem.Instance.Remove(this, _EventMa[i]);
